...
var TierListApp = React.createClass({displayName: "TierListApp",
  fetch_data: function() {
    var data = [
      {
        level: '1',
        heroes: [
          ...
          { name: 'JAINA', spec: 'assassin', skill_order: ['0']},
          { name: 'ILLIDAN', spec: 'assassin', skill_order: ['0']},
          ...
          { name: 'VIKINGS', spec: 'specialist', skill_order: ['0']},
          { name: 'MURADIN', spec: 'tank', skill_order: ['0']}
  ...
  render: function() {
    ...
    var tier_list = fetched_data.map(function(tier, index, tier_list){
      return React.createElement(Tier, {level: tier.level, heroes: tier.heroes})
    })

    return (
      React.createElement("tier_list", null, 
        tier_list
      )
    );
  }
...
var Routes = (
  React.createElement(Route, {handler: TierListApp}, 
    React.createElement(Route, {name: "/", handler: TierListApp})
  )
);
